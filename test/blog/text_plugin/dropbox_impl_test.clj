...
(deftest dropbox
  (testing "process"
    ...
    (is (= (plugin/process dropbox-plugin "![<TITLE>](db:<URL>)")
           "![<TITLE>](https://dl.dropboxusercontent.com/u/<USER-ID>/<URL>)"))
    (is (= (plugin/process dropbox-plugin "![<TITLE1>](db:<URL1>) ![<TITLE2>](db:<URL2>)")
           (str "![<TITLE1>](https://dl.dropboxusercontent.com/u/<USER-ID>/<URL1>)" " "
                "![<TITLE2>](https://dl.dropboxusercontent.com/u/<USER-ID>/<URL2>)")))))
